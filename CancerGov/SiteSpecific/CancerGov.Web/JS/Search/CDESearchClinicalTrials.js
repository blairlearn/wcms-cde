...
function InstitutionListButtonClickHandler(event) {
    dynPopWindow('/Common/PopUps/CTLSearch/CTLookup.aspx?type=' + ids.institution + '&fld=institution&title=Find+Hospitals/Institutions', 'InstitutionLookup', 'width=681px,menubar=no,location=no,height=580px');
    Event.stop(event);
}
...
function DrugListButtonClickHandler(event) {
    dynPopWindow('/Common/PopUps/CTLSearch/CTLookup.aspx?type=' + ids.drug + '&fld=drug&title=Find+Drug', 'DrugLookup', 'width=681px,menubar=no,location=no,height=580px');
    Event.stop(event);
}
...
function InterventionListButtonClickHandler(event) {
    dynPopWindow('/Common/PopUps/CTLSearch/CTLookup.aspx?type=' + ids.intervention + '&fld=intervention&title=Treatment/Intervention', 'InterventionLookup', 'width=681px,menubar=no,location=no,height=580px');
    Event.stop(event);
}
...
function InvestigatorListButtonClickHandler(event) {
    dynPopWindow('/Common/PopUps/CTLSearch/CTLookup.aspx?type=' + ids.investigator + '&fld=investigator&title=Find+Trial+Investigators', 'InvestigatorLookup', 'width=681px,menubar=no,location=no,height=580px');
    Event.stop(event);
}
...
function LeadOrgListButtonClickHandler(event) {
    dynPopWindow('/Common/PopUps/CTLSearch/CTLookup.aspx?type=' + ids.leadOrg + '&fld=leadOrg&title=Find+Lead+Organizations', 'LeadOrgLookup', 'width=681px,menubar=no,location=no,height=580px');
    Event.stop(event);
}
