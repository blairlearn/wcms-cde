...
namespace CancerGov.Dictionaries.SnippetControls
{
    public class DictionarySearchBlock : SnippetControl
    {
        ...
        private void SetupCommon()
        {
            ...
            radioStarts.InputAttributes.Add("data-autocorrect", "dict-radio-starts");
            radioContains.InputAttributes.Add("data-autocorrect", "dict-radio-contains");
        ...
        private void SetupSpanish()
        {
            ...
            AutoComplete1.Attributes.Add("data-autocorrect", "dict-autocomplete");
