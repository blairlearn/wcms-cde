		...
		<asp:DataGrid id="summaryList" CssClass="black-text" runat="server" AutoGenerateColumns="False"
			...
			<Columns>
				<asp:TemplateColumn HeaderText="ID">
					<ItemTemplate>
						<asp:HyperLink id="docLink" Text='<%# DataBinder.Eval(Container.DataItem,"SummaryID") %>' NavigateUrl='<%# DataBinder.Eval(Container.DataItem,"prettyurl")+ "?allpages=1&print=1" %>' Target="_blank" runat="server" />
					</ItemTemplate>
				</asp:TemplateColumn>
