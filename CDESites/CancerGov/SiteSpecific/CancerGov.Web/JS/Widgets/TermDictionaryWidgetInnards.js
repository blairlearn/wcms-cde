        ...
        if (xmlhttp2.readyState==4 && xmlhttp2.status==200)  {
            ...
            if ($('meta[name="content-language"]').attr("content") == "es")
            {
                var definition = '<p><b>' + someJSON[0].item + '</b> ' + someJSON[0].TermDictionaryDetail.TermPronunciation + 
                    ...
                    '<a href="//www.cancer.gov/espanol/publicaciones/diccionario?CdrID=' + someJSON[0].id + '" target="_blank">' +
             ...
             else
             {
                var definition = '<p><b>' + someJSON[0].item + '</b> ' + someJSON[0].TermDictionaryDetail.TermPronunciation + 
                    '</p><p>' + someJSON[0].TermDictionaryDetail.DefinitionHTML + '</p><p>' +
                    '<a href="//www.cancer.gov/publications/dictionaries/cancer-terms?CdrID=' + someJSON[0].id + '" target="_blank">' +
