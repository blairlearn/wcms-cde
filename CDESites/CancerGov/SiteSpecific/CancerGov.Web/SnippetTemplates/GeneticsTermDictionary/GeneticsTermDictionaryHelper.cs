...
namespace NCI.Web.CDE.UI.SnippetControls
{
    ...
    public static class GeneticsTermDictionaryHelper
    {
        ...
        public static string SearchBlock(string url, string searchString, string language, string heading, string buttonText, bool contains)
        {
            ...
            if (contains)
            {
                searchBlock.AppendLine("      <div class=\"small-12 columns\"><span class='radio' Name='radioStarts'><input id='radioStarts' name='contains'  type='radio' onchange='autoFunc();' />");
                searchBlock.AppendLine("      <label for='radioStarts' class=\"inline\" id='lblStartsWith'>Starts with</label></span>");
                searchBlock.AppendLine("      <span class='radio' Name='radioContains'><input id='radioContains' value=\"true\" name='contains' type='radio' checked='checked' onchange='autoFunc();'  />");
            ...
            searchBlock.AppendLine("      <div class=\"medium-2 columns left\"><input type='submit'  id='btnGo' value='Submit' title='Search' class='submit button postfix'  /></div>");
            searchBlock.AppendLine("      </div>");
