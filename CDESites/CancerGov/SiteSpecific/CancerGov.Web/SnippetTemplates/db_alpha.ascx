                    ...
                    <asp:Panel ID="pnlTermSearch" runat="server" CssClass="pnlTermSearch">
                        <div class="searchboxTopRow" class="searchboxTopRow">
                            <div id="searchboxContainer" runat="server" class="searchboxContainer"> 
                                ...
                                <CGov:AutoComplete CssClass="AutoComplete1" Name="AutoComplete1" ID="AutoComplete1" runat="server" CallbackFunc="ACOnSubmit" autocomplete="off" minWidth="333"/>
                            ...
                            <div id="searchboxBtn" runat="server" class="searchboxBtn">
                                <asp:ImageButton CssClass="btnGo" Name="btnGo"  ID="btnGo" runat="server" ImageUrl="/images/red_go_button.gif" AlternateText="Search" ToolTip="Search" />
                            </div>
                            
                            <div id="searchboxStarts" runat="server" class="searchboxStarts">
                                <asp:RadioButton Name="radioStarts" ID="radioStarts" runat="server" Checked="True" GroupName="sgroup" Text="Starts with" ToolTip="Search item starts with this" />
                            </div>
                            ...
                            <div id="searchboxContains" class="searchboxContains">
                                <asp:RadioButton Name="radioContains" ID="radioContains" runat="server" GroupName="sgroup" Text="Contains" ToolTip="Search item contains this" />
