...
namespace NCI.Web.UI.WebControls.Menus
{
    ...
    [ToolboxData("<{0}:ContextMenuEventItem runat=server></{0}:ContextMenuEventItem>")]
    public class ContextMenuEventItem : ContextMenuItem, IButtonControl
    {
        ...
        protected override void RenderContents(HtmlTextWriter output)
        {
            ...
            {
                _linkButton.Attributes.Add("style",
                    String.Format("background-image: url({0}); background-repeat: no-repeat;", this.IconSrc));
            }

            _linkButton.RenderControl(output);
        }
