...
{
    public class PageOptionsLanguageCollection : StateManagedCollection
    {
        ...
        public PageOptionsLanguageCollection CloneFields()
        {
            PageOptionsLanguageCollection languageItems = new PageOptionsLanguageCollection();
            foreach (PageOptionsButtonLanguageItem languageItem in this)
            {
