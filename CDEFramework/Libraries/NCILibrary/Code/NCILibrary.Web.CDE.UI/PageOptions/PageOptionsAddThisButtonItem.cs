...
{
    public class PageOptionsAddThisButtonItem : PageOptionsButtonItem
    {
        ...
        */
        ...
        protected PageOptionsAddThisButtonItem CreatePageOptionsAddThisButtonItem()
        {
            return new PageOptionsAddThisButtonItem();
        }
