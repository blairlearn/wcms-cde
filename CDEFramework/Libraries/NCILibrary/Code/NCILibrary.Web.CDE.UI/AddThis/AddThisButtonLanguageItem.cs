...
{
    public class AddThisButtonLanguageItem : IStateManager
    {

        private AddThisButtonCollection _buttonsCollection;
        ...
        public AddThisButtonCollection ButtonsCollection
        {
            get
            {
                if (this._buttonsCollection == null)
                {
                    this._buttonsCollection = new AddThisButtonCollection();
        ...
        protected AddThisButtonLanguageItem CreateAddThisLanguageItem()
        {
