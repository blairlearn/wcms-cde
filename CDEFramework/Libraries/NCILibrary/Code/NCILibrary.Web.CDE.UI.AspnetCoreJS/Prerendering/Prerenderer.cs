...
namespace NCI.Web.CDE.UI.SnippetControls.Prerendering
{
    /// <summary>
    /// Performs server-side prerendering by invoking code in Node.js.
    /// This was lifted from https://github.com/aspnet/JavaScriptServices/blob/dev/src/Microsoft.AspNetCore.SpaServices/Prerendering/Prerenderer.cs
    /// as we dont need all the other SPA things, but do need this.
    /// </summary>
